...
const STOP_WORDS = new Set([
  // عربي
  "في","من","على","الى","إلى","عن","مع","هذا","هذه","ذلك","التي","الذي","كل","بعد","قبل",
  "ما","لا","هل","كيف","ليه","ازاي","إزاي","يا","او","أو","و","ثم","لكن","حتى","انا","أنا",
  "احنا","احلى","اقوى","افضل","أفضل","جديد","حصري","شرح","فيديو","الحلقة","الجزء","كامل",
  // إنجليزي
  "the","a","an","and","or","of","to","in","on","for","with","is","are","be","this","that",
  "how","what","why","best","top","new","full","official","video","part","ep","episode",
  "vs","you","your","my","i","it","can","do","does","not","from","by","at","as","we",
]);
